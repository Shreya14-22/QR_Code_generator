...
#Take the inputs from the user to create the QR code.
#Lable for the window

headingFrame = Frame(wn,bg="azure",bd=5)
headingFrame.place(relx=0.15,rely=0.05, relwidth=0.7, relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR code with Data Flair", bg='azure', font=('Times',20,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)

##Take the input of the text or URL to get QR code
Frame1 = Frame(wn,bg='Blue')
Frame1.place(relx=0.1, rely=0.15,relwidth=0.7, relheight=0.3)

label1 = Label(Frame1,text="Enter the text/URL:", bg="Blue", fg='azure', font=('Courier',13,'bold'))
...
Frame2 = Frame(wn,bg="Blue")
Frame2.place(relx=0.1, rely=0.35,relwidth=0.7, relheight=0.3)

label2 = Label(Frame2,text="Enter the Location to save the QR Code:", bg="Blue", fg='azure', font=('Courier',13,'bold'))
...
Frame3 = Frame(wn, bg="Blue")
Frame3.place(relx=0.1, rely=0.55,relwidth=0.7, relheight=0.3)

label3 = Label(Frame3,text="Enter the Name of the QR Code:", bg="Blue", fg='azure', font=('Courier',13,'bold'))
...
Frame4 = Frame(wn, bg="Blue")
Frame4.place(relx=0.1, rely=0.75,relwidth=0.7, relheight=0.2)

label4 = Label(Frame4,text="Enter the size from 1 to 40 with 1 begin 21x21:", bg="Blue", fg='azure', font=('Courier',13,'bold'))
...
def generateCode():
    ...
    messagebox.showinfo("DataFlair QR Code Generator","QR Code is sucessfully save!!")

#Button to generate and save th QR Code

button = Button(wn, text='Generate Code', font=('Courier', 15,'normal'), command=generateCode)
button.place(relx=0.35, rely=0.4, relwidth=0.25, relheight=0.05)
